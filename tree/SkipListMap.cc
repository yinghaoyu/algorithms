...
class SkipListNode
{
 public:
  ...
  bool isKeyEqual(K otherKey) { return (key == "" && otherKey == "") || (key != "" && otherKey != "" && key.compare(otherKey) == 0); }
};
...
class SkipListMap
{
 public:
  ...
  K firstKey() { return head->nextNodes.at(0) != nullptr ? head->nextNodes.at(0)->key : "nullptr"; }
